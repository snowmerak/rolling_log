...
func TestSigner44_SignAndVerify(t *testing.T) {
	pvk, err := mldsa.NewSigner44()
	if err != nil {
...
func TestSigner44_MarshalAndUnmarshal(t *testing.T) {
	pvk, err := mldsa.NewSigner44()
	if err != nil {
		t.Fatalf("NewSigner44: %v", err)
	}
	...
	pvk2, err := new(mldsa.Signer44).Unmarshal(data)
	if err != nil {
