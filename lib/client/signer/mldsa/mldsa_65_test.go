...
func TestSigner65_SignAndVerify(t *testing.T) {
	pvk, err := mldsa.NewSigner65()
	if err != nil {
...
func TestSigner65_MarshalAndUnmarshal(t *testing.T) {
	pvk, err := mldsa.NewSigner65()
	if err != nil {
		t.Fatalf("NewSigner44: %v", err)
	}
	...
	pvk2, err := new(mldsa.Signer65).Unmarshal(data)
	if err != nil {
